...
An example of using an ETags.
  ...
  fb_user = FbGraph::User.new('1234567', :name => 'Nov Matake').fetch 
  
  # If you receives Etag header, fb_graph add it to the fetched object
  fb_user.etag # => "a1b2c3..."
  
  # If FbGraph object has etag attributes, fb_graph put 'If-None-Match' header when calling Graph API
  # If the object is not modified yet (= fb_graph receives 304 HTTP status code), fb_graph won't update any attributes of the object.
  FbGraph::User.new('1234567').fetch(:etag => 'a1b2c3...')
