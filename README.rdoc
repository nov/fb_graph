...
I'm continuously updating RDoc now.
Please see RDoc.info (http://rdoc.info/github/nov/fb_graph), and if the document is missing or hard to understand, please ask me on github.
Both issues and DM are OK.
...
==== Attributes
  ...
  FbGraph::Event.attributes
  # => [:owner, :name, :description, :start_time, :end_time, :location, :venue, :privacy, :updated_time]

  FbGraph::Album.attributes
  # => [:from, :name, :description, :location, :link, :privacy, :count, :created_time, :updated_time]
