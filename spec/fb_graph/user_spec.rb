...
describe FbGraph::User, '#likes' do
  ...
  describe 'when access_token is given' do
    it 'should return liked pages with pagination info' do
      ...
      likes[:data].first.should == FbGraph::Page.new('378209722137', :name => 'Doing Things at the Last Minute', :category => "活動")
      likes[:data].last.should == FbGraph::Page.new('329322570299', :name => 'Dirtybird Records', :category => "Products_other")
