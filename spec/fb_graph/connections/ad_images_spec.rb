  ...
  context 'when included by FbGraph::AdAccount' do
    context 'when access_token is given' do
      it 'should return ad_images as FbGraph::AdImage' do
        mock_graph :get, 'act_22334455/adimages', File.join(MOCK_JSON_DIR, 'ad_accounts/ad_images/22334455_ad_images.json'), :access_token => 'valid' do
...
describe FbGraph::Connections::AdImages, '#ad_image!' do
  context 'when included by FbGraph::AdAccount' do
    it 'should return generated ad_image' do
      ...
      mock_graph :post, 'act_22334455/adimages', File.join(MOCK_JSON_DIR, 'ad_accounts/ad_images/post_with_valid_access_token.json') do
